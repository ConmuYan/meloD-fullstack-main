...
public class SongListController {
    ...
    // 创建用户的"我喜欢"歌单
    @PostMapping("/songList/myFavorite/create")
    public R createMyFavoriteSongList(@RequestParam Integer userId) {
        return songListService.createMyFavoriteSongList(userId);
    }
    
    // 获取用户的"我喜欢"歌单
    @GetMapping("/songList/myFavorite/detail")
    public R getMyFavoriteSongList(@RequestParam Integer userId) {
        return songListService.getMyFavoriteSongList(userId);
    }
}
