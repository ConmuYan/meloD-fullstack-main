  ...
  <div class="sign enhanced" style="opacity: 1; visibility: visible;">
    ...
    <el-form ref="signUpForm" label-width="70px" status-icon :model="registerForm" :rules="SignUpRules">
      <el-form-item prop="username" label="用户名">
        <enhanced-input v-model="registerForm.username" placeholder="用户名"></enhanced-input>
      </el-form-item>
      <el-form-item prop="password" label="密码">
        <enhanced-input type="password" placeholder="密码" v-model="registerForm.password"></enhanced-input>
      </el-form-item>
      ...
      <el-form-item prop="phoneNum" label="手机">
        <enhanced-input placeholder="手机" v-model="registerForm.phoneNum"></enhanced-input>
      </el-form-item>
      <el-form-item prop="email" label="邮箱">
        <enhanced-input v-model="registerForm.email" placeholder="邮箱"></enhanced-input>
      </el-form-item>
      <el-form-item prop="birth" label="生日">
        <el-date-picker type="date" placeholder="选择日期" v-model="registerForm.birth" style="width: 100%"></el-date-picker>
      </el-form-item>
      <el-form-item prop="introduction" label="签名">
        <el-input type="textarea" placeholder="签名（最多50字）" v-model="registerForm.introduction"  maxlength="50" show-word-limit :rows="3"></el-input>
      </el-form-item>
      ...
      <el-form-item class="sign-btn">
        <el-button type="primary" @click="handleSignUp">注册账户</el-button>
        <div class="secondary-buttons">
          <el-button @click="goBackRegist()">返回登录</el-button>
        </div>
      </el-form-item>
    </el-form>
  </div>
